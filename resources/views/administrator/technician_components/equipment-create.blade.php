...
@component('components.panel', ['title' => __('Add an equipment'), 'controller' => 'EquipmentCreateController'])
    ...
    <div class="form-group" ng-class="messages.errors.product_id.length > 0 ? 'has-error' : ''">
        ...
        <select name="product_id" id="product_id" class="form-control" ng-model="data.product_id" placeholder="{{__('Put a valid equipment type')}}">
    ...
    <div class="form-group" ng-class="messages.errors.name.length > 0 ? 'has-error' : ''">
        ...
        <input type="text" name="name" id="name" class="form-control" ng-model="data.name" placeholder="{{__('Put a valid equipment name')}}">
    ...
    <div class="form-group" ng-class="messages.errors.localisation.length > 0 ? 'has-error' : ''">
        ...
        <input type="text" name="localisation" id="localisation" class="form-control" ng-model="data.localisation" placeholder="{{__('Put equipment localisation')}}">
